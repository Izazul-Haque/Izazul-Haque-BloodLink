    ...
    <div class="tab-content">
       <div class="tab-pane container active" id="hospitals">
        <form action="file/hospitalLogin.php" method="post">
          ...
          <input type="submit" name="hlogin" value="Login" class="btn lr-btn btn-primary btn-block mb-4">
        </form>
       </div>
      ...
      <div class="tab-pane container fade" id="receivers">
         <form action="file/receiverLogin.php" method="post">
          ...
          <input type="submit" name="rlogin" value="Login" class="btn btn-primary lr-btn btn-block mb-4">
        </form>
      </div>

    </div>
    <a href="register.php" class="text-center mb-4 clickbtn" title="Click here to create an account">Don't have account?</a>
</div>
</div>
</div>
</div>
