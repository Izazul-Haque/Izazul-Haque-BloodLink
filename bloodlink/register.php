    ...
    <?php require 'message.php'; ?>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <div class="card x-rounded">
            <ul class="nav nav-tabs justify-content-center bg-lognreg" style="padding: 20px">
              <li class="nav-item">
    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="hospitals">
        ...
        <form action="file/hospitalReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="tel" name="hphone" placeholder="Hospital Phone Number" class="form-control mb-3">
          ...
          <input type="submit" name="hregister" value="Register" class="btn lr-btn btn-primary btn-block mb-4">
        </form>
       ...
       <div class="tab-pane container fade" id="receivers">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="submit" name="rregister" value="Register" class="btn lr-btn btn-primary btn-block mb-4">
        </form>

       </div>
    </div>
    <a href="login.php" class="text-center mb-4 clickbtn" title="Click here to login">Already have an account?</a>
</div>
</div>
</div>
</div>
