        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        If your blood group is A+: You can give blood to A+ and AB+. You can receive blood from A+, A-, O+ and O-
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">A-</div>
                    <div class="card-body">
                    If your blood group is A-: You can give blood to A-, A+, AB- and AB+. You can receive blood from A- and O-. 
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                    If your blood group is B+: You can give blood to A+ and AB+. You can receive blood from A+, A-, O+ and O-.
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    <div class="card-header text-center">B-</div>
                    <div class="card-body">
                    If your blood group is B-: You can give blood to B-, B+, AB+ and AB-. You can receive blood from B- and O-.You can give blood to B+ and AB+.
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <i class="fa fa-envelope"> </i> <a > bloodlink@gmail.com</a><br><br>
                        <i class="fa fa-mobile"> </i> <a > +8801234567899</a><br><br>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="row mb-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    If you are currently a smoker, it’s not too late to quit. Once you do, you will experience immediate and long-term health benefits. If you are not a smoker, that’s great! Do not start smoking and fight for your right to breathe tobacco-smoke-free air.</dd><br>
                    
                    <marquee class="mqbig" behavior="scroll" direction="left">
                    <dt> Drink only safe water | Get tested | Follow traffic laws | Talk to someone you trust if you're feeling down | Clean your hands properly | Have regular check-ups </dt>
                    </marquee><br><br>
